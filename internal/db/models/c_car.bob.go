...
func (s CCarSetter) SetColumns() []string {
	...
	if s.PowerAdjust != nil {
		vals = append(vals, "power_adjust")
	}

	if s.WeightPenalty != nil {
		vals = append(vals, "weight_penalty")
	}

	if s.DryTireSets != nil {
...
func (s CCarSetter) Overwrite(t *CCar) {
	...
	if s.NameShort != nil {
		t.NameShort = *s.NameShort
	}
	if s.CarID != nil {
		t.CarID = *s.CarID
	}
	if s.CCarClassID != nil {
		t.CCarClassID = *s.CCarClassID
	}
	if s.FuelPCT != nil {
		t.FuelPCT = *s.FuelPCT
	}
	if s.PowerAdjust != nil {
		t.PowerAdjust = *s.PowerAdjust
	}
	if s.WeightPenalty != nil {
		t.WeightPenalty = *s.WeightPenalty
	}
	if s.DryTireSets != nil {
		t.DryTireSets = *s.DryTireSets
	}
}
...
func insertCCarCCarEntries0(ctx context.Context, exec bob.Executor, cCarEntries1 []*CCarEntrySetter, cCar0 *CCar) (CCarEntrySlice, error) {
	for i := range cCarEntries1 {
		cCarEntries1[i].CCarID = &cCar0.ID
	}
