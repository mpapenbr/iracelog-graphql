...
type Event struct {
	...
	TireInfos            null.Val[types.JSON[json.RawMessage]] `db:"tire_infos" `
...
type EventSetter struct {
	...
	TireInfos            omitnull.Val[types.JSON[json.RawMessage]] `db:"tire_infos" `
}
...
type eventWhere[Q psql.Filterable] struct {
	...
	TireInfos            psql.WhereNullMod[Q, types.JSON[json.RawMessage]]
	R                    eventWhereR[Q]
}
...
func buildEventWhere[Q psql.Filterable](cols eventColumns) eventWhere[Q] {
	return eventWhere[Q]{
		...
		TireInfos:            psql.WhereNull[Q, types.JSON[json.RawMessage]](cols.TireInfos.Expression),
...
type eventPreloadBuf struct {
	...
	TireInfos            null.Val[types.JSON[json.RawMessage]]
}
