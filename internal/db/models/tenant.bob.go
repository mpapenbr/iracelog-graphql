...
var TenantErrors = &tenantErrors{
	ErrUniqueTenantPkey: &UniqueConstraintError{s: "tenant_pkey"},

	ErrUniqueTenantApiKeyUnique: &UniqueConstraintError{s: "tenant_api_key_unique"},

	ErrUniqueTenantExternalIdUnique: &UniqueConstraintError{s: "tenant_external_id_unique"},

	ErrUniqueTenantNameUnique: &UniqueConstraintError{s: "tenant_name_unique"},
}
