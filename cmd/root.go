...
import (
	...
	"github.com/mpapenbr/iracelog-graphql/cmd/server"
...
var rootCmd = &cobra.Command{
	Use:     "igql",
	Short:   "GraphQL backend for iRacelog",
	Long:    ``,
...
func init() {
	...
	rootCmd.PersistentFlags().StringVarP(&config.Addr,
		"addr",
		"a",
		"localhost:8080",
		"set graphql server listen address")

	rootCmd.PersistentFlags().DurationVar(&config.WaitForServices,
		"wait-for-services",
		15*time.Second,
